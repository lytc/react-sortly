...
export function convert(items, parentId) {
...
export function increaseTreeItem(items, itemIndex) {
  var updateFn = {};
...
export function decreaseTreeItem(items, itemIndex) {
  var updateFn = {};
  var item = items[itemIndex];
...
export function moveTreeItem(items, sourceIndex, targetIndex) {
...
export function add(items, itemData) {
...
export function insert(items, targetIndex, itemData) {
